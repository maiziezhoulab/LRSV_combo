...
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_normal}_noBND.vcf NA 50 100 0 -1  ${outdir}${prefix_normal}_noBND_50_100.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_normal}_noBND.vcf NA 101 500 0 -1  ${outdir}${prefix_normal}_noBND_101_500.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_normal}_noBND.vcf NA 501 1000 0 -1  ${outdir}${prefix_normal}_noBND_501_1000.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_normal}_noBND.vcf NA 1001 30000 0 -1  ${outdir}${prefix_normal}_noBND_1001_30000.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_normal}_noBND.vcf NA   30000 -1 0 -1  ${outdir}${prefix_normal}_noBND_30000_.vcf
...
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_cancer}_noBND.vcf NA 50 100 0 -1  ${outdir}${prefix_cancer}_noBND_50_100.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_cancer}_noBND.vcf NA 101 500 0 -1  ${outdir}${prefix_cancer}_noBND_101_500.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_cancer}_noBND.vcf NA 501 1000 0 -1  ${outdir}${prefix_cancer}_noBND_501_1000.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_cancer}_noBND.vcf NA 1001 30000 0 -1  ${outdir}${prefix_cancer}_noBND_1001_30000.vcf
${survivor_dir}/Debug/SURVIVOR filter ${outdir}${prefix_cancer}_noBND.vcf NA   30000 -1 0 -1  ${outdir}${prefix_cancer}_noBND_30000_.vcf
...
${survivor_dir}/Debug/SURVIVOR merge ${outdir}vcflist_50_100.txt 50 1 1 0 0 50 ${outdir}${prefix}_noBND_50_100_merged.vcf
...
${survivor_dir}/Debug/SURVIVOR merge ${outdir}vcflist_101_500.txt 101 1 1 0 0 101 ${outdir}${prefix}_noBND_101_500_merged.vcf
...
${survivor_dir}/Debug/SURVIVOR merge ${outdir}vcflist_501_1000.txt 501 1 1 0 0 501 ${outdir}${prefix}_noBND_501_1000_merged.vcf
...
${survivor_dir}/Debug/SURVIVOR merge ${outdir}vcflist_1001_30000.txt 1001 1 1 0 0 1001 ${outdir}${prefix}_noBND_1001_30000_merged.vcf
...
${survivor_dir}/Debug/SURVIVOR merge ${outdir}vcflist_30000_.txt 10000 1 1 0 0 10000 ${outdir}${prefix}_noBND_30000_merged.vcf
...
${survivor_dir}/Debug/SURVIVOR merge  ${outdir}vcflist_BND.txt 1000 1 1 0 0 0 ${outdir}${prefix}_BND_merged.vcf
...
Survivor by default does not have the size comparision feature when merging VCF files, so you need to split VCF file into different size ranges before merging (included in the code above).
