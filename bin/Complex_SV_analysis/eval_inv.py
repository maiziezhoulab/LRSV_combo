...
parser.add_argument('--benchfile','-bench',help="optional, default = /data/maiziezhou_lab/Yichen/Projects/LRSV_Project/nc_review_analysis/SV_simulation/workdir/sim_inv.bed",
	default = "/data/maiziezhou_lab/Yichen/Projects/LRSV_Project/nc_review_analysis/SV_simulation/workdir/sim_inv.bed")
